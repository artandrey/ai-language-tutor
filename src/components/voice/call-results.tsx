...
export function CallResults({ call }: CallResultsProps) {
  ...
  return (
    <div className="h-full min-h-screen bg-gradient-to-br from-gray-900 via-blue-900/20 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col max-w-2xl mx-auto p-4 pt-4 h-full min-h-screen justify-center">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-gray-900/40 backdrop-blur-sm rounded-3xl border border-gray-700/30 shadow-2xl flex-1 flex flex-col"
          >
              ...
              <ScrollArea className="h-full">
                ...
                {currentStage === 0 && (
                  ...
                  >
                    ...
                    <p className="text-base text-gray-300 mb-4">Great job!</p>
                        ...
                        {call.corrections.corrections.map(
                          (correction, index) => (
                            <motion.div
                              ...
                              className="bg-gray-900/60 border border-red-500/30 rounded-2xl p-4"
                            >
                ...
                {currentStage === 3 && (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-300 mb-8 max-w-2xl mx-auto">
                      ...
                      Swiftly. Keep practicing to improve your English speaking
                      skills!
                    </p>
