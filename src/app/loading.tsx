    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-white p-4">
      <div className="text-center">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute inset-0 w-16 h-16 mx-auto rounded-full bg-gradient-to-r from-blue-500/20 to-transparent animate-pulse"></div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="text-blue-600 text-sm">Preparing your experience</div>
        </div>
